...
We mitigate this with explicit evidence-path mapping and paired run records, but latent harness bugs remain possible.
...
The 3-seed replication shows high variance, and bootstrap CIs over paired seeds cross no-effect thresholds.
